...
namespace Reggie {
   public class AnimationManager {
        ...
        public enum Animations{Walk_Left, Walk_Right, Jump_Left, Jump_Right, Attack_Left, Attack_Right, Walk_Hat_Left, Walk_Hat_Right, Jump_Hat_Left, Jump_Hat_Right, Attack_Hat_Left, Attack_Hat_Right};
        ...
        public void animation(GameTime gameTime, ref Player player, SpriteBatch spriteBatch) 
        {
            ...
            switch (currentAnimation)
            {
                ...
                case Animations.Jump_Hat_Left:
                    ...
                    player.DrawSpriteBatch(spriteBatch, tempRec, Jump_Hat_Animation_Left.getSpriteEffects(), new Vector2(15, -20));
